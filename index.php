...
<body class="boomcity start">
	<div id="wrapper">
	    ...
	    <div class="intro-home" style="/*border:4px solid orange;*/">
	        <div class="row">
		...
		<footer>
            ...
            <div class=" foot-cta-home"><a href="http://marketingincolor.com" target="_blank"><img src="./images/mic_logo.png" /></a></div>
	    </footer>
	</div>
