...
<script type="text/javascript">
    function getParameterByName(name, url) {
        ...
        var ss_online = 'test';
        var ss_frequency = 'test';
        var result_name = 'test';
        var result_b_sng = 'test';
        var result_b_pos = 'test';
        var result_site = 'test';
        var result_product = 'test';
        var result_accessory = 'test';
        var result_his = 'test';
        var result_him = 'test';
        var result_he = 'test';
        ...
        if((ss_type == 'B2B') && (ss_team == 'No') && (ss_crm == 'Yes') && (ss_online == 'No') ) {
            dynamic_web_content_blurb = '<p>Prospects who visit ' + result_site + ' see content that’s relevant to their unique engagement and actions, thus improving ' + result_b_pos + ' chances of converting website visits into sales.</p><p>This begins by seamlessly integrating ' + result_b_pos + ' existing Customer Relationship Management (CRM) system into a whole suite of marketing automation services. Each website visitor is automatically delivered tailored messaging. For example, when prospects who haven\'t signed up for an upcoming webinar visit the website, they see an invitation to sign up. Those who have signed up see a thank you for signing up and a reminder of the webinar date and time.</p><p>They would also see ' + result_b_pos + ' local phone and address, further personalizing the online experience and delivering the information they need to purchase.</p>';
        }
        ...
        if((ss_type == 'B2B') && (ss_team == 'Yes') && (ss_crm == 'No') && (ss_online == 'Yes') ) {
            dynamic_email_blurb = '<p>' + result_name + ' at ' + result_b_sng + ' sends out automated dynamic emails to build personalized relationships with a growing database, effectively incentivize, and more. A powerful Customer Relationship Management system enables ' + result_his + ' to track opportunities from beginning to end and tailor the entire sales process to best manage ' + result_his + ' specific needs.</p><p>For example, ' + result_b_sng + ' sends out automated emails to hundreds of prospects after a trade show, each with personalized messaging that addresses them by name, thanks them for stopping by the booth, and is signed from that prospect\'s specific salesperson (including that salesperson\'s phone and email link). This helps each salesperson maintain a personal relationship with their customers, while still efficiently reaching out to a growing database. Further emails can be sent out according to each prospect\'s actions that continue the relationship and eventually lead to a purchase. And of course, every email includes a link to ' + result_site + ' where purchases can be made.</p>';
        }
        if((ss_type == 'B2B') && (ss_team == 'Yes') && (ss_crm == 'No') && (ss_online == 'No') ) {
            dynamic_email_blurb = '<p>' + result_name + ' at ' + result_b_sng + ' sends out automated dynamic emails to build personalized relationships with a growing database, effectively incentivize, and more. A powerful Customer Relationship Management system enables ' + result_him + ' to track opportunities from beginning to end and tailor the entire sales process to best manage ' + result_his + ' specific needs.</p><p>For example, ' + result_b_sng + ' sends out automated emails to hundreds of prospects after a trade show, each with personalized messaging that addresses them by name, thanks them for stopping by the booth, and is signed from that prospec\'’s specific salesperson (including that salesperson\'s phone and email link as well as the local business address and map link). This helps each salesperson maintain a personal relationship with their customers, while still efficiently reaching out to a growing database. Further emails can be sent out according to each prospect\'s actions that continue the relationship and eventually lead to a purchase.</p>';
        }
        if((ss_type == 'B2B') && (ss_team == 'No') && (ss_crm == 'Yes') && (ss_online == 'Yes') ) {
            dynamic_email_blurb = '<p>' + result_name + ' at ' + result_b_sng + ' sends out automated dynamic emails to build personalized relationships with a growing database, effectively incentivize, and more. ' + result_his + ' existing Customer Relationship Management system is seamlessly integrated into a whole suite of marketing automation services, enabling prospect engagement with the right message at the right time.</p><p>For example, ' + result_name + ' sends out automated emails to hundreds of prospects after a trade show, each with personalized messaging that addresses them by name, thanks them for stopping by the booth, and invites them to download a white paper. These prospects are then divided into two lists for a future mailing: those who downloaded the white paper and those who didn\'t. The messaging and incentives are continually fine-tuned to convert prospects into sales. And of course, every email includes a link to ' + result_site + ' where purchases can be made.</p>';
        }
        if((ss_type == 'B2B') && (ss_team == 'No') && (ss_crm == 'Yes') && (ss_online == 'No') ) {
            dynamic_email_blurb = '<p>' + result_name + ' at ' + result_b_sng + ' sends out automated dynamic emails to build personalized relationships with a growing database, effectively incentivize, and more. ' + result_his + ' existing Customer Relationship Management system is seamlessly integrated into a whole suite of marketing automation services, enabling prospect engagement with the right message at the right time.</p><p>For example, ' + result_name + ' sends out automated emails to hundreds of prospects after a trade show, each with personalized messaging that addresses them by name, thanks them for stopping by the booth, and invites them to download a white paper. These prospects are then divided into two lists for a future mailing: those who downloaded the white paper and those who didn\'t. The messaging and incentives are continually fine-tuned to convert prospects into sales.  </p><p>The emails are further customized by giving each prospect the correct contact information for their specific area, which could include ' + result_b_pos + ' local phone number, address and a map link.</p>';
        }
        if((ss_type == 'B2B') && (ss_team == 'No') && (ss_crm == 'No') && (ss_online == 'Yes') ) {
            dynamic_email_blurb = '<p>' + result_name + ' at ' + result_b_sng + ' sends out automated dynamic emails to build personalized relationships with a growing database, effectively incentivize, and more – even without a sales team. A powerful Customer Relationship Management system enables ' + result_him + ' to track opportunities from beginning to end and tailor the entire sales process to best manage ' + result_his + ' specific needs.</p><p>For example, ' + result_name + ' sends out automated emails to hundreds of prospects after a trade show, each with personalized messaging that addresses them by name, thanks them for stopping by the booth, and invites them to download a white paper. These prospects are then divided into two lists for a future mailing: those who downloaded the white paper and those who didn\'t. The messaging and incentives are continually fine-tuned to convert prospects into sales. And of course, every email includes a link to ' + result_site + ' where purchases can be made.</p>';
        }
        if((ss_type == 'B2B') && (ss_team == 'No') && (ss_crm == 'No') && (ss_online == 'No') ) {
            dynamic_email_blurb = '<p>' + result_name + ' at ' + result_b_sng + ' sends out automated dynamic emails to build personalized relationships with a growing database, effectively incentivize, and more – even without a sales team. A powerful Customer Relationship Management system enables ' + result_him + ' to track opportunities from beginning to end and tailor the entire sales process to best manage ' + result_his + ' specific needs.</p><p>For example, ' + result_name + ' sends out automated emails to hundreds of prospects after a trade show, each with personalized messaging that addresses them by name, thanks them for stopping by the booth, and invites them to download a white paper. These prospects are then automatically divided into two lists for a future mailing: those who downloaded the white paper and those who didn\'t. The messaging and incentives are continually fine-tuned to convert prospects into sales.</p><p>The emails are further customized by giving each prospect the correct contact information for their specific area, which could include ' + result_b_pos + ' local phone number, address and a map link.</p>';
        }
        if((ss_type == 'B2C') && (ss_team == 'Yes') && (ss_crm == 'Yes') && (ss_online == 'Yes') ) {
            dynamic_email_blurb = '<p>' + result_name + ' at ' + result_b_sng + ' sends out automated dynamic emails to build personalized relationships with a growing database, effectively incentivize, and more. ' + result_his + ' existing Customer Relationship Management system is seamlessly integrated into a whole suite of marketing automation services, enabling prospect engagement with the right message at the right time to optimize sales.</p><p>For example, ' + result_he + ' sends out automated emails with incentives that are relevant to each customer – those who haven\'t purchased a ' + result_product + ' are offered 20% off. Those who have already purchased a ' + result_product + ' are offered 20% off a ' + result_accessory + '. Each email is personalized by being addressed to the individual customer\'s name and is signed from their specific salesperson, including the salesperson\'s phone number and email link. And of course, every email includes a link to ' + result_site + ' where purchases can be made.</p>';
        }
        if((ss_type == 'B2C') && (ss_team == 'Yes') && (ss_crm == 'Yes') && (ss_online == 'No') ) {
            dynamic_email_blurb = '<p>' + result_name + ' at ' + result_b_sng + ' sends out automated dynamic emails to build personalized relationships with a growing database, effectively incentivize, and more. ' + result_his + ' existing Customer Relationship Management system is seamlessly integrated into a whole suite of marketing automation services, enabling prospect engagement with the right message at the right time to optimize sales.</p><p>For example, ' + result_he + ' sends out automated emails with incentives that are relevant to each customer – those who haven\'t purchased a ' + result_product + ' are offered 20% off. Those who have already purchased a ' + result_product + ' are offered 20% off a ' + result_accessory + '. Each email is personalized by being addressed to the individual customer\'s name and is signed from their specific salesperson, including the salesperson\'s phone number and email link.</p><p>Additionally, a local store address and map link is included, making it easy for customers to take advantage of the sale in their area.</p>';
        }
        if((ss_type == 'B2C') && (ss_team == 'Yes') && (ss_crm == 'No') && (ss_online == 'Yes') ) {
            dynamic_email_blurb = '<p>' + result_name + ' at ' + result_b_sng + ' sends out automated dynamic emails to build personalized relationships with a growing database, effectively incentivize, and more. A powerful Customer Relationship Management system enables ' + result_him + ' to track opportunities from beginning to end and tailor the entire sales process to best manage ' + result_his + ' specific needs.</p><p>For example, ' + result_he + ' sends out automated emails with incentives that are relevant to each customer – those who haven\'t purchased a ' + result_product + ' are offered 20% off. Those who have already purchased a ' + result_product + ' are offered 20% off a ' + result_accessory + '. Each email is personalized by being addressed to the individual customer\'s name and is signed from their specific salesperson, including the salesperson\'s phone number and email link. And of course, every email includes a link to ' + result_site + ' where purchases can be made.</p>';
        }
        if((ss_type == 'B2C') && (ss_team == 'Yes') && (ss_crm == 'No') && (ss_online == 'No') ) {
            dynamic_email_blurb = '<p>' + result_name + ' at ' + result_b_sng + ' sends out automated dynamic emails to build personalized relationships with a growing database, effectively incentivize, and more. A powerful Customer Relationship Management system enables ' + result_him + ' to track opportunities from beginning to end and tailor the entire sales process to best manage ' + result_his + ' specific needs.</p><p>For example, ' + result_he + ' sends out automated emails with incentives that are relevant to each customer – those who haven\'t purchased a ' + result_product + ' are offered 20% off. Those who have already purchased a ' + result_product + ' are offered 20% off a ' + result_accessory + '. Each email is personalized by being addressed to the individual customer\'s name and is signed from their specific salesperson, including the salesperson\'s phone number and email link.</p><p>Additionally, a local store address and map link is included, making it easy for customers to take advantage of the sale in their area.</p>';
        }
        ...
        if((ss_type == 'B2C') && (ss_team == 'No') && (ss_crm == 'Yes') && (ss_online == 'No') ) {
            dynamic_email_blurb = '<p>' + result_name + ' at ' + result_b_sng + ' sends out automated dynamic emails to build personalized relationships with a growing database, effectively incentivize, and more - even without a sales team. ' + result_his + ' existing Customer Relationship Management system is seamlessly integrated into a whole suite of marketing automation services, enabling prospect engagement with the right message at the right time to optimize sales.</p><p>For example, ' + result_he + ' sends out automated emails with incentives that are relevant to each customer – those who haven\'t purchased a ' + result_product + ' are offered 20% off. Those who have already purchased a ' + result_product + ' are offered 20% off a ' + result_accessory + '. Each email is personalized by being addressed to the individual customer\'s name and is signed from ' + result_name + ', including ' + result_his + ' phone number and email link.</p><p>Additionally, a local store address and map link is included, making it easy for customers to take advantage of the sale in their area.</p>';
        }
        if((ss_type == 'B2C') && (ss_team == 'No') && (ss_crm == 'No') && (ss_online == 'Yes') ) {
            dynamic_email_blurb = '<p>' + result_name + ' at ' + result_b_sng + ' sends out automated dynamic emails to build personalized relationships with a growing database, effectively incentivize, and more – even without a sales team. A powerful Customer Relationship Management system enables ' + result_him + ' to track opportunities from beginning to end and tailor the entire sales process to best manage ' + result_his + ' specific needs.</p><p>For example, ' + result_he + ' sends out automated emails with incentives that are relevant to each customer – those who haven\'t purchased a ' + result_product + ' are offered 20% off. Those who have already purchased a ' + result_product + ' are offered 20% off a ' + result_accessory + '. Each email is personalized by being addressed to the individual customer\'s name and is signed from ' + result_name + ', including ' + result_his + ' phone number and email link. And of course, every email includes a link to ' + result_site + ' where purchases can be made.</p>';
        }
        if((ss_type == 'B2C') && (ss_team == 'No') && (ss_crm == 'No') && (ss_online == 'No') ) {
            dynamic_email_blurb = '<p>' + result_name + ' at ' + result_b_sng + ' sends out automated dynamic emails to build personalized relationships with a growing database, effectively incentivize, and more – even without a sales team. A powerful Customer Relationship Management system enables ' + result_him + ' to track opportunities from beginning to end and tailor the entire sales process to best manage ' + result_his + ' specific needs.</p><p>For example, ' + result_he + ' sends out automated emails with incentives that are relevant to each customer – those who haven\'t purchased a ' + result_product + ' are offered 20% off. Those who have already purchased a ' + result_product + ' are offered 20% off a ' + result_accessory + '. Each email is personalized by being addressed to the individual customer\'s name and is signed from ' + result_name + ', including ' + result_his + ' phone number and email link.</p><p>Additionally, a local store address and map link is included, making it easy for customers to take advantage of the sale in their area.</p>';
        }
